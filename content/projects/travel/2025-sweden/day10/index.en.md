...
### Pictures
{{< galleries >}}
{{< gallery src="img1.jpg" title="Bicycles along the canal in Gothenburg" alt="Two loaded bicycles next to a flower-adorned bridge railing over a canal; behind them, historic buildings and a clock tower." >}}
{{< gallery src="img2.jpg" title="Coastal cove with boats" alt="A coastal cove with calm waters, piers, small boats, and white buildings along the shore; in the foreground, tall grass and a road." >}}
{{< gallery src="img3.jpg" title="Out and About on the Coast" alt="A smiling man wearing a bike helmet and sunglasses on a path next to calm water, with low-lying land on the horizon." >}}
{{< gallery src="img4.jpg" title="Sugar Cookies" alt="A hand holds a round, golden-brown pastry with coarse sugar crystals against a blurred background." >}}
{{< gallery src="img5.jpg" title="Shelter at the Edge of the Forest" alt="A sunny meadow at the edge of the forest with red wooden huts, a bicycle, and a moss-covered open shelter." >}}
{{< /galleries >}}
