...
### Pictures
{{< galleries >}}
{{< gallery src="img1.jpg" title="Bicycle at the Signposts" alt="A dark bicycle with yellow accents is leaning next to road signs by the side of a road; behind it are a meadow and dark-colored cattle." >}}
{{< gallery src="img2.jpg" title="On the Dune Trail" alt="A cyclist wearing a black helmet and sunglasses stands next to a sandy path through grassy dunes." >}}
{{< gallery src="img3.webp" title="A Sandy Path to the Sea" alt="A light-colored sandy path leads through the dune grass to the sea; low dunes lie to the left, and the coast is visible to the right." >}}
{{< gallery src="img4.jpg" title="At the beach" alt="A man wearing sunglasses and a rust-orange T-shirt stands on a sandy beach facing the ocean and the low-hanging sun." >}}
{{< /galleries >}}
